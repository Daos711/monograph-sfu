...
\makeatletter
\AtBeginDocument{%
  % Номинально 1 строка, но с гибкостью −4pt для вёрстки страниц
  % NB: «1\baselineskip» извлекает dimen из glue-регистра;
  %     голый \baselineskip TeX съедает целиком, и «plus ...» утекает в текст
  \abovedisplayskip=1\baselineskip plus 0pt minus 4pt\relax
  \abovedisplayshortskip=1\baselineskip plus 0pt minus 4pt\relax
  \belowdisplayskip=1\baselineskip plus 0pt minus 4pt\relax
  \belowdisplayshortskip=1\baselineskip plus 0pt minus 4pt\relax
...
\titleformat{\chapter}[block]
  {\normalfont\normalsize\bfseries}
  {\thechapter}{0.5em}{}
% before-skip = -5pt компенсирует \topskip (≈14.5pt) так, чтобы
% верх заглавных букв совпадал с верхней границей текстового блока
\titlespacing*{\chapter}{\parindent}{-5pt}{\baselineskip}

\titleformat{name=\chapter,numberless}[block]
  {\normalfont\normalsize\bfseries\centering}
  {}{0pt}{\MakeUppercase}
\titlespacing*{name=\chapter,numberless}{0pt}{-5pt}{\baselineskip}
...
% ВРЕМЕННО: показывает границы текстового блока — убрать перед финальной сборкой
