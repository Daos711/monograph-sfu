...
% Восстановление отступа первой строки после выключных формул
\makeatletter
\renewcommand{\@doendpe}{%
  \@endpetrue
...
% Запрет переносов в тексте (по требованию преподавателя)
\tolerance=10000
\hbadness=10000
\hyphenpenalty=10000
...
% --- Заголовки ---
\usepackage{hyphenat}   % \nohyphens — запрет переносов в заголовках (СТУ 7.5–07–2021)
\usepackage{titlesec}
