...
\defbibenvironment{bibliography}
  ...
  {\endlist}
  {\item}
% Короткое тире в диапазонах страниц и разделителях: С. 57-63
\renewcommand*{\bibrangedash}{\textendash}
% Переопределить разделитель полей gost (длинное тире → короткое)
\AtBeginBibliography{%
  \DeclareDelimFormat{titleyeardelim}{\addperiod\space\textendash\space}%
